 ...
 * <OL>
 * <p/>
 * <LI>Keys to "get" are strings which are known to be interned, so that "==" is
 * used instead of "String.equals". (Interning could be document-relative
 * instead of global.)
 * <p/>
 * <LI>It's not synchronized, since it's to be used only by one thread at a
 * time.
 * <p/>
 * <LI>The keys () enumerator allocates no memory, with live updates to the data
 * disallowed.
 * <p/>
