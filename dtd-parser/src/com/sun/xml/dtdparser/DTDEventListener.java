...
public interface DTDEventListener extends EventListener
{
	...
	/**
	 * Receive notification of a Processing Instruction. Processing instructions
	 * contain information meaningful to the application.
	 *
	 * @param target The target of the proceessing instruction which should have
	 *               meaning to the application.
	 * @param data   The instruction itself which should contain valid XML
	 *               characters.
	 * @throws SAXException
	 */
	...
	/**
	 * Receive notification of a Notation Declaration. Notation declarations are
	 * used by elements and entities for identifying embedded non-XML data.
	 *
	 * @param name     The notation name, referred to by entities and elements.
	...
	/**
	 * Receive notification of an unparsed entity declaration. Unparsed entities
	 * are non-XML data.
	 *
	 ...
	 * @param value The value of the entity, which may include unexpanded entity
	 *              references. Character references will have been expanded.
	 * @throws SAXException
	 ...
	 * <p>
	 * <p>
	 * If a system identifier is present, and it is a relative URL, the parser
	 * will have resolved it fully before passing it through this method to a
	 * listener.
	 * </p>
	 *
	 ...
	 */
	public void externalGeneralEntityDecl(
	...
	/**
	 * Receive notification of the end of a DTD. The parser will invoke this
	 * method only once.
	 *
	 * @throws SAXException
	 ...
	 * <p>
	 * <P>
	 * Note that processing instructions are the mechanism designed to hold
	 * information for consumption by applications, not comments. XML systems
	 * may rely on applications being able to access information found in
	 * processing instructions; this is not true of comments, which are
	 * typically discarded.
	 *
	...
	/**
	 * Receive notification that a CDATA section is beginning. Data in a CDATA
	 * section is is reported through the appropriate event, either
	 ...
	 *
	 * @param elementName      name of the element whose content model is going
	 *                         to be defined.
	 * @param contentModelType {@link #CONTENT_MODEL_EMPTY} this element has
	 *                         EMPTY content model. This notification will be
	 *                         immediately followed by the corresponding
	 *                         endContentModel. {@link #CONTENT_MODEL_ANY} this
	 *                         element has ANY content model. This notification
	 *                         will be immediately followed by the corresponding
	 *                         endContentModel. {@link #CONTENT_MODEL_MIXED}
	 *                         this element has mixed content model. #PCDATA
	 *                         will not be reported. each child element will be
	 *                         reported by mixedElement method.
	 *                         {@link #CONTENT_MODEL_CHILDREN} this elemen has
	 *                         child content model. The actual content model
	 *                         will be reported by childElement,
	 *                         startModelGroup, endModelGroup, and connector
	 *                         methods. Possible call sequences are:
	 *                         <p>
	 *                         START := MODEL_GROUP MODEL_GROUP :=
	 *                         startModelGroup TOKEN (connector TOKEN)*
	 *                         endModelGroup TOKEN := childElement | MODEL_GROUP
	 */
	 ...
	 * <p>
	 * <p>
	 * DTD allows the same attributes to be declared more than once, and in that
	 * case the first one wins. I think this method will be only fired for the
	 * first one, but I need to check.
	 */
	...
	/**
	 * receives notification of child element of mixed content model. this
	 * method is called for each child element.
	 *
